...
export default function NotFound() {
  return (
    <div className=" flex min-h-screen flex-col items-center  justify-center space-y-10 bg-black-400 text-center text-silver-500 antialiased">
      <h3 className="text-3xl font-bold text-pink lg:text-5xl">404 😅</h3>
      ...
      <Link
        href="/"
        className="flex w-1/2 items-center justify-center rounded-md border border-pink py-3 text-center  font-bold uppercase transition-all hover:border-pink hover:text-pink md:w-1/4 lg:w-1/5"
      >
