...
export const CookieBar = () => {
  ...
  return (
    !accepted && (
      <div className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-between border-t border-primary bg-dark-400 px-4 py-3 font-bold transition-all hover:border-primary hover:text-primary">
